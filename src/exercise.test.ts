...
describe("getCities", () => {
  ...
  const schedules1: Array<StaffSchedule> = [{ name: "Jordan", rota: ["Monday", "Tuesday", "Wednesday"] },
  { name: "Darwin", rota: ["Saturday", "Sunday", "Tuesday", "Wednesday"] },
  { name: "Virgil", rota: ["Wednesday"] }];

  const schedules2: Array<StaffSchedule> = [{ name: "Jordan", rota: ["Monday", "Tuesday", "Wednesday"] },
  { name: "Darwin", rota: ["Saturday", "Sunday", "Tuesday", "Wednesday"] },
  { name: "Virgil", rota: ["Wednesday"] },
